    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                DateTime.TryParse(bDay, out birthDate);
                var phoneNumber = info.Principal.FindFirstValue(ClaimTypes.HomePhone);
                var mobileNumber = info.Principal.FindFirstValue(ClaimTypes.MobilePhone);
                ...
                var city = info.Principal.FindFirstValue(ClaimTypes.StateOrProvince);
                ...
                {
                    _logger.LogError("Failed to create Person", e.ToString());
                }
